...
if __name__ == "__main__":
    ...
    dice_fold3 = io.load_csv_to_arr('outputs/seg_fold3/results/csv/Epoch200_Step104800/dice.csv')
    dice_fold4 = io.load_csv_to_arr('outputs/seg_fold4/results/csv/Epoch200_Step104800/dice.csv')
